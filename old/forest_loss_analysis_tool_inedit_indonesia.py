...
biomassmosaic = r'D:\Users\sgibbes\indonesia_remaining_forest\mosaics.gdb\biomass'
...
lossyearmosaic = r'D:\Users\sgibbes\indonesia_remaining_forest\mosaics.gdb\loss'
tcdmosaic = r'D:\Users\sgibbes\indonesia_remaining_forest\mosaics.gdb\tcd'
...
with arcpy.da.SearchCursor(shapefile, ("Shape@", admin_column_name)) as cursor:
    ...
    for row in cursor:
        ...
        if overwrite == "false":
            if column_name2 == r'IDN29d365_8' or column_name2 == r'IDN29d367_8'or column_name2 == r'IDN29d365_9' :
                pass
            else:
                if forest_loss == "true" and carbon_emissions == "false":
